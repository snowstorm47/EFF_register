    ...
    <FormControlLabel value="male" control={<Radio />} label="Male" />
          ...
          <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                ...
                <Select 
                id="instractorEducationalLevel"
                onChange={handleChange}
                fullwidth
                >
                  <MenuItem> Mid Level Instractor</MenuItem>
                  <MenuItem> Higher Level Instractor</MenuItem>
                  <MenuItem> CAF D Level Instractor </MenuItem>
                  <MenuItem> CAF C Level Instractor </MenuItem>
                  <MenuItem>CAF B Level Instractor</MenuItem>
                  <MenuItem>CAF A Level Instractor</MenuItem>
                  <MenuItem>CAF Pro Level Instractor</MenuItem>
                  <MenuItem>FIFA Level Instractor</MenuItem>
...
export default Instractorsform;